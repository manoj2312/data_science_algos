...
execfile("z_3_2_slopetestordering.py")
...
storeth=[]
compnum = 1
clusunsun=0    # 0l 2l    #cluster 1,2,3 ++    4, +    5, -
dura = 15
sart = 0
endt = 200
...
# res1(t) = store[0]*price_of_stock0(t) + store[1]*price_of_stock1(t) + store[2]*price_of_stock2(t) + .....
...
# res(t) = tmpor(t)[0]*price_of_stock0(t) + tmpor(t)[1]*price_of_stock1(t) + tmpor(t)[2]*price_of_stock2(t) + .....
for j in range(len(shet[0])):
    if(j<sart):
